...
public class LogInConstants {
    ...
    public static final String passwordNotCorrect = "Password is not correct.";
    public static final String userNotFound = "No User Found with this username";
    ...
    public static final String loginSuccessful = "You're in!";
